/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b18ca197a01eab21601952c730b4afe9)
// Runtime types generated with workerd@1.20260714.1 2026-07-03 nodejs_als
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	CMS_PROVIDER: string;
	PUBLIC_CMS_PROVIDER: string;
	PUBLIC_SITE_URL: string;
	PUBLIC_DIRECTUS_URL: string;
	DIRECTUS_URL: string;
	DIRECTUS_TOKEN: string;
	PUBLIC_ENABLE_VISUAL_EDITING: string;
	DRAFT_MODE_SECRET: string;
}
